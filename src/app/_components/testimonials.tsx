"use client"
import useEmblaCoursel from 'embla-carousel-react'
...
export function Testimonials () {
    ...
    const [emblaRef, emblaApi] = useEmblaCoursel({
      loop: true
    })
  ...
  return (
    <section className="bg-[#b7eef0] py-16">
        <div className="container mx-auto px-4"></div>
        <div>
          <h2 className="text-4xl font-bold text-center mb-12" data-aos="flip-up" data-aos-delay="200">Depoimentos dos nossos clientes</h2>
                        ...
                        <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                          <div className='flex flex-col items-center text-center space-y-4'>
                              <div className='relative w-24 h-24'>
                                  ...
                                  fill
                                  sizes='96px'
                                  className='object0cover rounded-full'
                                  /> 
                              </div>
